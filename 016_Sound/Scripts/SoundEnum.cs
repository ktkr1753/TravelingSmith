...
public partial class SoundEnum
{
	//BGM
	public const string bgm_1 = "bgm_1.ogg";        //罪惡感
    public const string bgm_2 = "bgm_2.ogg";		//早上的準備工作
    public const string bgm_3 = "bgm_3.mp3";        //海風
    public const string bgm_4 = "bgm_4.mp3";        //心的迷宮
    public const string bgm_5 = "bgm_5.ogg";        //初次的配方
    public const string bgm_6 = "bgm_6.ogg";        //悠閒小鎮
    public const string bgm_7 = "bgm_7.ogg";        //忍耐搔癢
    public const string bgm_8 = "bgm_8.ogg";        //超越悲傷
    public const string bgm_9 = "bgm_9.ogg";        //像笨蛋一樣
